...
import android.luna.rs232.Ack.DataStruct.MakeDrinkFinishResData;
...
public class AckDrinkFinish extends IBaseCmdRespose<MakeDrinkFinishResData> implements IEncode {
    ...
    public void Encodeing2class(String[] ack) {
        ...
        dataindex+=2;
        setCmd(value);
        setResdata(new MakeDrinkFinishResData());
