...
import android.luna.rs232.Ack.DataStruct.MakeDrinkResData;

/**
 * Created by Lee.li on 2018/7/4.
 */

public class AckMakeDrink extends IBaseCmdRespose<MakeDrinkResData> implements IEncode {
    ...
    public void Encodeing2class(String[] ack) {
        ...
        dataindex+=2;
        setCmd(value);
        setResdata(new MakeDrinkResData());
