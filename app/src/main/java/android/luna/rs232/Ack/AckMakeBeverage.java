...
import android.luna.rs232.Ack.DataStruct.MakeBeverageResData;

/**
 * Created by Lee.li on 2018/7/3.
 */

public class AckMakeBeverage extends IBaseCmdRespose<MakeBeverageResData> implements IEncode {
    ...
    public void Encodeing2class(String[] ack) {
        ...
        dataindex+=2;
        setCmd(value);
        setResdata(new MakeBeverageResData());
