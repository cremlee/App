...
import android.luna.rs232.Ack.DataStruct.ConfigFinishResData;
...
public class AckConfigFinish extends IBaseCmdRespose<ConfigFinishResData> implements IEncode {
    ...
    public void Encodeing2class(String[] ack) {
        ...
        dataindex+=2;
        setCmd(value);
        setResdata(new ConfigFinishResData());
