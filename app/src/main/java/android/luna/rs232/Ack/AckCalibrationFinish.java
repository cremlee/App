...
import android.luna.rs232.Ack.DataStruct.CalibrationFinishResData;
...
public class AckCalibrationFinish extends IBaseCmdRespose<CalibrationFinishResData> implements IEncode {
    ...
    public void Encodeing2class(String[] ack) {
        ...
        dataindex+=2;
        setCmd(value);
        setResdata(new CalibrationFinishResData());
