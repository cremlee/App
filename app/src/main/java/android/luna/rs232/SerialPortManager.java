...
public class SerialPortManager {
	...
	protected SerialPortManager(ICommunication iCommunication) {
...
//				int iCmd = Integer.parseInt(cmd.substring(i, i + 2), 16);
//				mOutputStream.write(iCmd);
//			}
//			return true;
//		} catch (IOException e) {
//			e.printStackTrace();
