...
public class IngredientInstant implements Serializable {
	...
	@DatabaseField(defaultValue = "0")
	private int mixStart=0;
	@DatabaseField(defaultValue = "10")
	private int mixStop=10;
			
	public int getMixStart() {
		return mixStart;
	}

	public void setMixStart(int mixStart) {
		this.mixStart = mixStart;
	}

	public int getMixStop() {
		return mixStop;
	}

	public void setMixStop(int mixStop) {
		this.mixStop = mixStop;
	}
