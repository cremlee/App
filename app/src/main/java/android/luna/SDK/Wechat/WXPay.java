...
import android.luna.SDK.Wechat.WXPayConstants.SignType;
...
public class WXPay {
    ...
    public void setTransactionid(String a)
    {
        ((WXPayConfigImpl)config).setPrepay_id(a);
    }
    public void setouttradeno(String a)
    {
        ((WXPayConfigImpl)config).setOut_trade_no(a);
    }

    public String getTransactionid()
    {
        return  ((WXPayConfigImpl)config).getPrepay_id();
    }

    public String getouttradeno()
    {
        return  ((WXPayConfigImpl)config).getOut_trade_no();
    }
