package android.luna.ViewUi.SeekBar;
...
public class SeekBarPressure extends View {
    ...
    private double defaultScreenHigh = 10;  //默认后滑块位置百分比
...
//        this.setBackgroundColor(Color.BLACK);
        ...
        notScrollBarBg = resources.getDrawable(R.drawable.ic_settings_seekbar_grey);
        hasScrollBarBg = resources.getDrawable(R.drawable.ic_settings_seekbar_blue);
        mThumbLow = resources.getDrawable(R.drawable.ic_settings_seekbar_thum);
        mThumbHigh = resources.getDrawable(R.drawable.ic_settings_seekbar_thum);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mOffsetLow = formatDouble(defaultScreenLow / 10 * (mDistance ))+ mThumbWidth / 2;
        mOffsetHigh = formatDouble(defaultScreenHigh / 10 * (mDistance)) + mThumbWidth / 2;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        text_Paint.setColor(getResources().getColor(R.color.title_text_color2));
        ...
        mThumbHigh.draw(canvas);
         ...
         progressLow = formatDouble((mOffsetLow - mThumbWidth / 2) * 10 / mDistance);
         progressHigh = formatDouble((mOffsetHigh - mThumbWidth / 2) * 10 / mDistance);
//            Log.d(TAG, "onDraw-->mOffsetLow: " + mOffsetLow + "  mOffsetHigh: " + mOffsetHigh   + "  progressLow: " + progressLow + "  progressHigh: " + progressHigh);
        canvas.drawText((int) progressLow + "", (int)mOffsetLow - 2 - 2, 25, text_Paint);
        canvas.drawText((int) progressHigh + "", (int)mOffsetHigh - 2, 25, text_Paint);
...
//            Log.d("ACTION_UP", "------------------");
    ...
    public void setProgressLow(double  progressLow) {
        ...
        mOffsetLow = formatDouble(progressLow / 10 * (mDistance ))+ mThumbWidth / 2;
        isEdit = true;
        refresh();
    }
    ...
    public void setProgressHigh(double  progressHigh) {
        ...
        mOffsetHigh = formatDouble(progressHigh / 10 * (mDistance)) + mThumbWidth / 2;
        isEdit = true;
        refresh();
    }
