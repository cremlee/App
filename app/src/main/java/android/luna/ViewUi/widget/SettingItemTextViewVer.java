...
public class SettingItemTextViewVer extends LinearLayout {
	...
	public SettingItemTextViewVer(Context context) {
		super(context, null);
		this.mContext = context;
	}

	public SettingItemTextViewVer(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.mContext = context;
		initViews(attrs);
	}
	...
	private void initViews(AttributeSet attrs) {
		View view = LayoutInflater.from(mContext).inflate(R.layout.layout_setting_item_textviewver, this, true);
