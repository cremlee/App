...
public class SettingItemColorItem extends LinearLayout {
	...
	public SettingItemColorItem(Context context) {
		super(context, null);
		this.mContext = context;
	}

	public SettingItemColorItem(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.mContext = context;
		initViews(attrs);
	}
