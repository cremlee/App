...
public class DashboardView extends View {
    ...
    private int mSection = 2; // 值域（mMax-mMin）等分份数
    ...
    private void init() {
        ...
        mColors = new int[]{ContextCompat.getColor(getContext(), R.color.material_red_400),
                ContextCompat.getColor(getContext(), R.color.material_red_200),
                ContextCompat.getColor(getContext(), R.color.material_yellow_400),
                ContextCompat.getColor(getContext(), R.color.material_yellow_300),
                ContextCompat.getColor(getContext(), R.color.material_yellow_200),
                ContextCompat.getColor(getContext(), R.color.material_yellow_100),
                ContextCompat.getColor(getContext(), R.color.material_green_100),
                ContextCompat.getColor(getContext(), R.color.material_green_200),
                ContextCompat.getColor(getContext(), R.color.material_green_300),
                ContextCompat.getColor(getContext(), R.color.material_green_400)
        };
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mRectFInnerArc.set(
                getPaddingLeft() + mStrokeWidth+ dp2px(30),
                getPaddingTop() + mStrokeWidth+ dp2px(30),
                getMeasuredWidth() - getPaddingRight() - mStrokeWidth- dp2px(30),
                getMeasuredWidth() - getPaddingBottom() - mStrokeWidth- dp2px(30)
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawColor(ContextCompat.getColor(getContext(), R.color.material_black));
        /**
         * 画圆弧
         */
        mPaint.setStyle(Paint.Style.STROKE);
        mPaint.setStrokeWidth(mStrokeWidth);
        mPaint.setColor(ContextCompat.getColor(getContext(), R.color.material_grey_400));
        ...
        mPaint.setColor(ContextCompat.getColor(getContext(), R.color.material_black));
        int r = mRadius / 8;
    ...
    private SweepGradient generateSweepGradient() {
        SweepGradient sweepGradient = new SweepGradient(mCenterX, mCenterY,
                mColors,
                new float[]{0, 24 / 360f, 48 /360f,
                        72 / 360f, 96 / 360f, 120 /360f,
                        144 / 360f, 168 / 360f, 192 /360f,
                        mSweepAngle / 360f}
        );
