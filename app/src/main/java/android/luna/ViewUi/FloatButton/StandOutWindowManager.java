package android.luna.ViewUi.FloatButton;

import android.content.Context;
import android.graphics.Point;
import android.luna.Utils.Logger.EvoTrace;
import android.luna.ViewUi.FloatButton.constants.StandOutFlags;
import android.luna.ViewUi.FloatButton.util.Utils;
...
public class StandOutWindowManager {
    ...
    private StandOutWindowManager(Context context) {
        ...
        this.mSysWindowManager = (WindowManager) context.getSystemService(Context.WINDOW_SERVICE);
    }
    ...
    private WindowWrapper createWindowWrapperInstance(Class<? extends WindowWrapper> cls, Integer id) {
        ...
        if (cls != null) {
            try {
                ...
                EvoTrace.e(TAG,"createWindowWrapperInstance error = "+e.getMessage());
        ...
        if (child != null && cachedWindow == null){
            ...
            if (args != null) {
                try {
                    ...
                    EvoTrace.e(TAG, "Your custom view must implement ParamReceiver, or you can not receive params!");
                }
...
//            }
    ...
    private void removeWindowView(int id, Window window, WindowWrapper wrapper) {
        // remove the window from the window menuManager
        try{
            mSysWindowManager.removeViewImmediate(window);
