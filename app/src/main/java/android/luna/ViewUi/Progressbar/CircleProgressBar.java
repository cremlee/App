package android.luna.ViewUi.Progressbar;
...
public class CircleProgressBar extends ProgressBar {
    ...
    private void initFromAttributes(Context context, AttributeSet attrs) {
        ...
        mProgressTextSize = a.getDimensionPixelSize(R.styleable.CircleProgressBar_progress_text_size_1, UnitUtils.dip2px(getContext(), DEFAULT_PROGRESS_TEXT_SIZE));
        ...
        mProgressTextColor = a.getColor(R.styleable.CircleProgressBar_progress_text_color_1, Color.parseColor(COLOR_FFF2A670));
    ...
    private void drawProgressText(Canvas canvas) {
        ...
        String progressText = String.format(mProgressTextFormatPattern, getProgress()*100/getMax());
