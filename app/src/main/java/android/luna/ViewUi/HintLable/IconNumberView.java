package android.luna.ViewUi.HintLable;
...
public class IconNumberView extends View {
    ...
    public IconNumberView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //bitmap = ((BitmapDrawable)getResources().getDrawable(R.drawable.ico_info)).getBitmap();
