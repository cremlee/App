package android.luna.ViewUi.Mybutton;
...
public class FancyButton extends LinearLayout {
    ...
    private ImageView setupIconView() {
        if (mIconResource != null) {
            ...
            if (mTextView != null) {
                ...
                iconViewParams.rightMargin = 0;
                iconViewParams.leftMargin = 0;
            } else {
    ...
    private void initAttributesArray(TypedArray attrsArray) {
        ...
        micon = attrsArray.getResourceId(R.styleable.FancyButtonsAttrs_fb_icon,0);
        Drawable icon = null;
        try {
            mIconResource = getResources().getDrawable(micon);    //attrsArray.getDrawable(R.styleable.FancyButtonsAttrs_fb_iconResource);
